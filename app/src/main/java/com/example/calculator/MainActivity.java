...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.num_1);
        button2 = findViewById(R.id.num_2);
        button3 = findViewById(R.id.num_3);
        button4 = findViewById(R.id.num_4);
        button5 = findViewById(R.id.num_5);
        button6 = findViewById(R.id.num_6);
        button7 = findViewById(R.id.num_7);
        button8 = findViewById(R.id.num_8);
        button9 = findViewById(R.id.num_9);
        button_add = findViewById(R.id.num_add);
        button_sub = findViewById(R.id.num_sub);
        button_multi = findViewById(R.id.num_multi);
        button_div = findViewById(R.id.num_divide);
        button_clr = findViewById(R.id.num_clear);
